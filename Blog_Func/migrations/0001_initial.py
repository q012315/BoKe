    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(verbose_name='发布时间', auto_now_add=True)),
                ('blog', models.ForeignKey(verbose_name='博客', to='Blog_Func.Blog')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.AddField(
            model_name='blog',
            name='catagory',
            field=models.ForeignKey(verbose_name='分类', to='Blog_Func.Catagory'),
        ),
        migrations.AddField(
            model_name='blog',
            name='tags',
            field=models.ManyToManyField(verbose_name='标签', to='Blog_Func.Tag'),
        ),
    ]
